...
app.get('/manaloto_johnzelle', function (req, res) {
  console.log("Got a GET request for /manaloto_johnzelle");
  res.send('I am Johnzelle Manaloto and I am a IT - Web Development student');
});
